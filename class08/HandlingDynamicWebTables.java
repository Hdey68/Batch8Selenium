    ...
    public static void main (String[] args) throws InterruptedException {
        ...
        for(int i=1; i< rows.size ( );i++){// starting to loop
            ...
            if(rowText.contains ( "Bob Feather" )){// setting a condition to click on checkbox
                driver.findElements ( By.xpath ( "//table[@id='ctl00_MainContent_orderGrid']/tbody/tr/td[1]" )).get(i-1).click ();// setting a condition to click on checkbox // grabbing a single row checkbox and clicking
                break;
            }
        }
